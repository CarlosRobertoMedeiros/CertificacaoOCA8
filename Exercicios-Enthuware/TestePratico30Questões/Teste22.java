class Teste22{
	...
	public static void incr(int n ){n++;}  //2
	public static void incr(int[] n ){n[0]++;} //2
	
}
/**
Arrays are proper objects (i.e. iArr instanceof Object returns true) and Object 
references are passed by value (so effectively, it seems as though objects are being 
passed by reference).
